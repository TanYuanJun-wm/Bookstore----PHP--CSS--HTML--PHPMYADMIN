...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $stmt->execute([
            ...
            'Ways' => 'CREDIT' // Example payment method
        ]);
...
<small>Please enter the name exactly as it appears on the card.</small><br><br>

<label for="card_number">Card Number:</label>
<input type="text" id="card_number" name="card_number" required><br><br>
<small>Please enter a 16-digit card number (no spaces or dashes).</small><br><br>

<label for="expiry_date">Expiry Date:</label>
<input type="month" id="expiry_date" name="expiry_date" required><br><br>
<small>Please enter the card's expiry date in MM/YY format.</small><br><br>

<label for="cvv">CVV:</label>
<input type="text" id="cvv" name="cvv" required><br><br>
<small>Please enter the 3-digit CVV number located on the back of your card.</small><br><br>
    ...
    <button type="button" onclick="window.location.href='order2.php';">Change payment method</button>
</form>
<br><hr><br>
